...
#ifndef AZPLUGINS_THERMOSTAT_MTTK_SLLOD_H_
#define AZPLUGINS_THERMOSTAT_MTTK_SLLOD_H_
...
class Thermostat2
    ...
    */
    Thermostat2(std::shared_ptr<Variant> T,
    ...
    */
    ...
    std::shared_ptr<ComputeThermoSLLOD> m_thermo;
...
class MTTKThermostatSLLOD : public Thermostat2
    {
    public:
    /** Construct the thermostat.
    ...
    */
    MTTKThermostatSLLOD(std::shared_ptr<Variant> T,
                   std::shared_ptr<ParticleGroup> group,
                   std::shared_ptr<ComputeThermoSLLOD> thermo,
                   std::shared_ptr<SystemDefinition> sysdef,
                   Scalar tau)
        : Thermostat2(T, group, thermo, sysdef), m_tau(tau)
        {
        }
    ...
    */
    ...
    MTTKThermostatSLLOD::state m_state {};
    };

} // end namespace azplugins
} // end namespace hoomd

#endif // AZPLUGINS_THERMOSTAT_MTTK_SLLOD_H_
