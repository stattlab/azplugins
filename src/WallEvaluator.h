...
//! Base class for wall potential parameters
/*!
 * This class covers the default case of a simple wall potential that doesn't do
 ...
 */
struct WallPotentialParameters
    {
#ifndef __HIPCC__
    WallPotentialParameters() { }

    WallPotentialParameters(pybind11::dict v, bool managed = false) { }
...
class WallEvaluator
    {
    public:
    typedef WallPotentialParameters param_type;
