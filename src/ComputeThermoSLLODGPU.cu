...
__global__ void gpu_compute_thermo_final_sums(Scalar* d_properties,
    ...
    if (threadIdx.x == 0)
        ...
        d_properties[md::thermo_index::translational_kinetic_energy] = Scalar(ke_trans_total);
        d_properties[md::thermo_index::rotational_kinetic_energy] = Scalar(ke_rot_total);
        d_properties[md::thermo_index::potential_energy] = Scalar(pe_total);
        d_properties[md::thermo_index::pressure] = pressure;
        }
    }
...
__global__ void gpu_compute_pressure_tensor_final_sums(Scalar* d_properties,
    ...
    if (threadIdx.x == 0)
        ...
        d_properties[md::thermo_index::pressure_xx] = final_sum[0] / V;
        d_properties[md::thermo_index::pressure_xy] = final_sum[1] / V;
        d_properties[md::thermo_index::pressure_xz] = final_sum[2] / V;
        d_properties[md::thermo_index::pressure_yy] = final_sum[3] / V;
        d_properties[md::thermo_index::pressure_yz] = final_sum[4] / V;
        d_properties[md::thermo_index::pressure_zz] = final_sum[5] / V;
        }
    }
